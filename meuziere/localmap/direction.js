...
window.QwantDirection = {
  ...
  // Autocompletion
  autocompletion: function(input, div, gps){
    ...
    xhr.onload = function(){
      ...
      if(xhr.responseURL.includes("q=" + encodeURIComponent(QwantDirection.$i(input).value)) + "&"){
        ...
        if(navigator.geolocation){
          html += "<div class=itinerary_suggest_your_position onclick=\"QwantDirection.chooseCurrentPosition('" + input + "','" + gps + "','" + div + "')\"><div class=itinerary_suggest_your_position_icon></div>" + _('Your position') + "</div>";
        }
        for(var i in json.features){
          ...
          html += "<div class=itinerary_autocomplete_item onclick=\"QwantDirection.chooseSuggestion('" + input + "','" + gps + "','" + div + "','" + i + "')\"><div class='autocomplete-icon icon icon-" + icon + "'></div><div class=itinerary_suggest_line1>"+line1+"</div><div class=itinerary_suggest_line2>"+line2+"</div></div>";
        }
        QwantDirection.$i(div).innerHTML = html;
      }
    };
  },
