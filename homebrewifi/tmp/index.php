...
// BDD
//mysql_connect("sql209.byetcluster.com", "b10_6569367", "thebest");
//mysql_connect("localhost", "75186", "thebest");
mysql_connect("mysql6.000webhost.com", "a3000824_ul", "thebest1");


//mysql_select_db("b10_6569367_homebrewifi");
//mysql_select_db("75186");
...
<fieldset style = "width: 700px; background-color: white;">
	...
	<br/>
	~ Développé par Xem avec PAlib et PHP pour la Nintendomax DS Dev Compo 2010 ~
</fieldset>

<br/>

<fieldset style = "width: 700px; background-color: white;">
	<a href = "#">Télécharger l'application DS</a><br/>(bientôt disponible)
	<br/>
	<br/>
	...
	<br/>
	- Télécharger l'application DS HomebreWifi
	<br/>
	- Installer le dossier HOMEBREW sur son linker
	<br/>
...
<?php
// Liste
$liste = mysql_query("SELECT * FROM homebrew ORDER BY nom");
?>
